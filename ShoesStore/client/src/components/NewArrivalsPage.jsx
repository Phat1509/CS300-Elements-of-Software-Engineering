...
const newArrivalsProducts = [
  {
    id: 101,
    name: "Future Sprint Elite 2025",
    price: 159.99,
    image:
      "https://images.unsplash.com/photo-1687980985791-7c9b631a74cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZXclMjBzbmVha2VycyUyMDIwMjV8ZW58MXx8fHwxNzYxMTkwNjE0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "Running",
    isNew: true,
  },
  {
    ...
    <div className="na">
      ...
      <section className="na-head">
        <div className="container">
          ...
          <p className="na-sub">
            Discover our latest collection of premium footwear. Fresh styles
            just landed for the new season.
          </p>
        </div>
      </section>
